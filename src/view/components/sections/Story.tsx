...
export default function Story() {
    return (
        <PageSection background="bg-ivory">
            <div className="mb-[500px] mx-auto max-w-6xl">
                ...
                <div className="mx-auto mt-20 max-w-2xl text-center">
                    ...
                    <p className="mt-8 leading-9 text-lg text-muted">
                        ...
                        <br />
                        Однажды, он меня позвал погулять. Начали разговаривать, и сразу почувствовали непринуждённость и понимание друг друга.
                        <br />
